...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .directions-panel h3{margin:0 0 10px;font-size:14px;color:var(--navy-dark);display:flex;justify-content:space-between;align-items:center;}
  .directions-panel h3 button{border:none;background:none;font-size:17px;color:#999;cursor:pointer;}
  .dp-stop{display:flex;align-items:flex-start;gap:8px;font-size:13px;padding:7px 8px;border-radius:8px;background:#f7f6f1;margin-bottom:6px;}
  .dp-stop .dot{width:11px;height:11px;border-radius:50%;flex-shrink:0;margin-top:4px;}
  ...
  .dp-stop .stop-actions{display:flex;flex-direction:column;gap:2px;flex-shrink:0;}
  .dp-stop .stop-actions button{
    border:none;background:transparent;color:#a39d8a;cursor:pointer;font-size:12px;
    width:18px;height:14px;line-height:14px;padding:0;border-radius:3px;
  }
  ...
  .dp-stop .remove-btn{font-size:15px;color:#c0a99a;}
  ...
  @media (max-width:760px){
    ...
    .dp-stop{gap:10px;padding:9px 8px;}
    .dp-stop .stop-actions{gap:5px;}
    .dp-stop .stop-actions button{width:36px;height:32px;font-size:17px;}
...
<div class="app">
  ...
  <div class="body">
    ...
    <div class="directions-panel" id="directionsPanel">
      <h3>Walking directions <button id="dpClose">&times;</button></h3>
